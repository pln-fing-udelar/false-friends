...
def classify_friends_and_predict(friend_pairs, model_es, model_pt, translation_matrix, clf=svm.SVC(), n_folds=5):
    ...
    #
    # single_run_measure = calculate_measures(tn, fp, fn, tp)
